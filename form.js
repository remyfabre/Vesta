...
$('.input-number-increment-20').click(function() {
...
$(document).ready(function(){
  $("#formcontentslide4").change(function() {
    var buttonslide4 = document.getElementById("buttonslide4");
...
$('#down11').click(function() {
  ...
  if (val1) {
    if (val1 <= val2){
      ...
      $('#buildingfloorscnt').val(Math.max(val1 - 1, 0));
    }
  } else {
    if (!val2){
...
$(document).ready(function(){
  $("#formcontentslide5").change(function() {
    var buttonslide5 = document.getElementById("buttonslide5");
...
$(document).ready(function(){
  $("#formcontentslide6").change(function() {
    var buttonslide6 = document.getElementById("buttonslide6");
